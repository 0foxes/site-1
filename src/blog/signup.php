        ...
        <body>
            <div class="text">
                <?php
                    ...
                    // Info from the form
                    $name= $mysqli -> real_escape_string(filter_var($_POST['userName'], FILTER_SANITIZE_STRING));
                    $email= $mysqli -> real_escape_string(filter_var($_POST['userEmail'], FILTER_SANITIZE_STRING));
                    $userIp = getUserIP();
                    $userTime = time();
